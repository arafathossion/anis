  ...
  a.helpers.media = {
    defaults: {
      ...
      metacafe: {
        ...
        url: function (a, t, o) {
          return (
            (o.swf.flashVars = "playerVars=" + e.param(t, !0)),
            "//www.metacafe.com/fplayer/" + a[1] + "/.swf"
          );
        },
      },
      dailymotion: {
        ...
        if (a.hasOwnProperty(i) && ((r = a[i]), (m = c.match(r.matcher)))) {
          (p = r.type),
            (l = e.extend(
              ...
              {},
              r.params,
              o[i] || (e.isPlainObject(a[i]) ? a[i].params : null)
            )),
            (c =
              "function" === e.type(r.url)
                ? r.url.call(this, m, l, o)
                : t(r.url, m, l));
          break;
        }
...
/*! @vimeo/player v2.1.0 | (c) 2018 Vimeo | MIT License | https://github.com/vimeo/player.js */
!(function (e, t) {
        ...
        if (c(t.origin) && t.data && "spacechange" === t.data.event)
          for (var n = e.querySelectorAll("iframe"), r = 0; r < n.length; r++)
            if (n[r].contentWindow === t.source) {
              ...
              o &&
                o.className.indexOf("vimeo-space") !== -1 &&
        ...
        !(function (t, n, r) {
          ...
          function o(e, t, r) {
            ...
            try {
              t === !1
                ? r.reject(e.msg)
                : ((o = t === !0 ? e.msg : t.call(void 0, e.msg)),
                  o === r.promise
            ...
            value: function (e) {
              ...
              return new T(function (o, i) {
                return n.ready().then(function () {
                  t(n, e, { resolve: o, reject: i }), m(n, e, r);
                });
              });
            },
          },
              ...
              return new T(function (r, o) {
                return (
                  ...
                  n.ready().then(function () {
                    t(n, e, { resolve: r, reject: o }), m(n, e);
                  })
                );
              });
            },
            ...
            value: function (e, n) {
              ...
              return T.resolve(n).then(function (n) {
                ...
                return r.ready().then(function () {
                  return new T(function (o, i) {
                    t(r, e, { resolve: o, reject: i }), m(r, e, n);
                  });
                });
              });
            },
    ...
    buildPlayer: function (options) {
      return this.each(function () {
        ...
        v.canPlayType && (canPlayHTML5 = !0),
          canPlayHTML5 && jQuery.extend(playerVars, { html5: 1 }),
          jQuery.browser.msie &&
            ...
            (YTPlayer.isBackground && ytp.backgroundIsInited) ||
              ...
              jQuery(YTPlayer).on("YTPChanged", function () {
                return YTPlayer.isInit
                  ? void 0
                  : ((YTPlayer.isInit = !0),
                    jQuery.browser.mobile && YTPlayer.isPlayer
                                  ...
                                  switch (state) {
                                    ...
                                    case 0:
                                      ...
                                      data.loop
                                        ...
                                        !data.loop && YTPlayer.isBackground
                                          ? YTPlayer.wrapper.CSSAnimate(
                                              { opacity: 0 },
                                              2e3
                                            )
                                          : data.loop && YTPlayer.loop++,
                                        controls
    ...
    checkForState: function (a) {
      ...
      clearInterval(a.getState),
        (a.getState = setInterval(function () {
          ...
          if (
            ((g = g < a.player.getDuration() ? g : 0),
            a.player.time != b.currentTime)
          ) {
          ...
          if (
            ((a.player.time = b.currentTime),
            0 == a.player.getVolume()
              ? c.addClass("isMuted")
              : c.removeClass("isMuted"),
            a.opt.showControls &&
              (b.totalTime
                ? d
                    .find(".mb_YTPTime")
                    .html(
                      jQuery.mbYTPlayer.formatTime(b.currentTime) +
                        " / " +
                        jQuery.mbYTPlayer.formatTime(b.totalTime)
                    )
                : d.find(".mb_YTPTime").html("-- : -- / -- : --")),
            a.opt.stopMovieOnBlur &&
              (document.hasFocus()
                ? document.hasFocus() &&
                  !a.hasFocus &&
                  ((a.hasFocus = !0), c.playYTP())
                : 1 == a.state && ((a.hasFocus = !1), c.pauseYTP())),
            1 == a.player.getPlayerState() &&
              (parseFloat(a.player.getDuration() - 3) <
                a.player.getCurrentTime() ||
                (g > 0 && parseFloat(a.player.getCurrentTime()) > g)))
          ) {
            if (a.isEnded) return;
            if (
              ((a.isEnded = !0),
            ...
            e.loop
              ? a.player.seekTo(f, !0)
              : (a.player.pauseVideo(),
                a.wrapper.CSSAnimate({ opacity: 0 }, 1e3, function () {
                  var b = jQuery.Event("YTPEnd");
                  if (
                    ((b.time = a.player.time),
                    jQuery(a).trigger(b),
                    a.player.seekTo(f, !0),
                    !a.isBackground)
                  ) {
